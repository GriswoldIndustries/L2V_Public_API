...
cert_dir = os.path.join(os.path.expanduser('~'), 'GitHub', 'L2V_Public_API', 'Public Assets API')
...
client_cert = os.path.join(cert_dir, 'kdarmstadt_assets.Public_Asset_API.link2valves.com.crt')
key_file = os.path.join(cert_dir, 'kdarmstadt_assets.Public_Asset_API.link2valves.com.key')
